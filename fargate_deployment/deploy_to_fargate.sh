...
build_overrides_json() {
  ...
  # CHANGES: added KFOLDS, HPO_MAX_JOBS, HPO_MAX_PARALLEL, EVAL_METRIC, OBJECTIVE_METRIC,
  #          XGB_INSTANCE_TYPE, LABEL_COL, SMOKE_ROWS (and kept NN_INSTANCE_TYPE, etc.)
  local names=(
